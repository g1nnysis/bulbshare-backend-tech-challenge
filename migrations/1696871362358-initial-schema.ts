...
export class InitialSchema1696871362358 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE channel ADD CONSTRAINT fk_organization_id FOREIGN KEY (organization_id) REFERENCES organization(id);`)
    await queryRunner.query(`ALTER TABLE brief ADD CONSTRAINT fk_channel_id FOREIGN KEY (channel_id) REFERENCES channel(id);`)
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE channel DROP FOREIGN KEY fk_organization_id`)
